...
export default function Header() {
  ...
  return (
    <header className="border-b-2 border-gray-200 dark:border-gray-700 bg-inherit fixed h-[3.75rem] sm:h-[4.5rem] w-screen flex justify-between items-center px-4 sm:px-5 transition-[height] duration-200 z-10">
