...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`w-[1.125rem] h-[1.125rem] sm:w-6 sm:h-6 rounded-[0.75rem] bg-black dark:bg-white absolute transition-[width,height,left,background] duration-200 ${
          resolvedTheme === "light"
            ? "left-[0.125rem] sm:left-[0.1875rem]"
            : "left-[1.4375rem] sm:left-[1.9375rem]"
        }`}
      />
    </button>
  );
